...
// je vérifie ici si le mail et le message ont bien été complétés
if (
...
$isFileLoaded = false;
// 1 - je check qu'il y a bien un fichier envoyé, si oui, 2 - je vérifie qu'il fasse moins d'un 1mo avant de le return
if (isset($_FILES['screenshot']) && $_FILES['screenshot']['error'] == 0){
    if ($_FILES['screenshot']['size'] > 1000000){
        echo('Le fichier ne peut être envoyé, image trop volumineuse');
        return;
    }
// 3 - je check si l'extension n'est pas autorisée
...
// 5 - je valide le fichier et le stocke définitivement
